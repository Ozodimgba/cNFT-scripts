...
async function mintOneCNFT() {
    ...
    const merkleTree = loadWalletKey("TRERRpwR59za9tqDM7KGoSmPvaYz4DnhmRbk5DDJRUZ.json").publicKey;
    ...
    const collectionMint = new PublicKey("CnHGMQggCdVYr9qrSL6gJMbGvpFRciPZ7ekkBSyLuRZ5")
