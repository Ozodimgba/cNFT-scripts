...
import { ASSOCIATED_TOKEN_PROGRAM_ID, AccountMeta, AccountMetaReadonly, Logger, RENT_PROGRAM_ID, SYSTEM_PROGRAM_ID, SYSVAR_RENT_PUBKEY, TOKEN_PROGRAM_ID, findProgramAddress, getMultipleAccountsInfo, parseSimulateLogToJson, parseSimulateValue, simulateMultipleInstruction, splitTxAndSigners, } from '../common';
...
export class Liquidity extends Base {
    ...
    static async makeCreatePoolInstructionSimple(params) {
    ...
    static async makeCreatePoolV4InstructionV2Simple({ connection, programId, marketInfo, baseMintInfo, quoteMintInfo, baseAmount, quoteAmount, startTime, ownerInfo, associatedOnly = false, computeBudgetConfig, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, }) {
        const frontInstructions = [];
        const endInstructions = [];
        const frontInstructionsType = [];
        const endInstructionsType = [];
