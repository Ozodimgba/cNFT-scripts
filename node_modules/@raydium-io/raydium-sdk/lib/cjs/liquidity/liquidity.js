...
class Liquidity extends base_1.Base {
        ...
        if (version === 4 || version === 5) {
            ...
            return {
                ...
                innerTransaction: {
                    ...
                    signers: [],
                    lookupTableAddress: [poolKeys.lookupTableAccount].filter((i) => !i.equals(web3_js_1.PublicKey.default)),
    ...
    static makeCreatePoolV4InstructionV2Simple({ connection, programId, marketInfo, baseMintInfo, quoteMintInfo, baseAmount, quoteAmount, startTime, ownerInfo, associatedOnly = false, computeBudgetConfig, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
