...
class SwapMath {
    static swapCompute(programId, poolId, tickArrayCache, tickArrayBitmap, tickarrayBitmapExtension, zeroForOne, fee, liquidity, currentTick, tickSpacing, currentSqrtPriceX64, amountSpecified, lastSavedTickArrayStartIndex, sqrtPriceLimitX64) {
        ...
        // state.tick > MIN_TICK
            ...
            const tickState = tick_1.TickUtils.nextInitTick(tickArrayCurrent, state.tick, tickSpacing, zeroForOne);
        ...
        try {
            const { nextStartIndex: tickAarrayStartIndex } = tickQuery_1.TickQuery.nextInitializedTickArray(state.tick, tickSpacing, zeroForOne, tickArrayBitmap, tickarrayBitmapExtension);
