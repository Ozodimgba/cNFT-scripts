...
class Clmm extends base_1.Base {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                innerTransaction: {
                    ...
                    lookupTableAddress: [poolInfo.lookupTableAccount].filter((i) => !i.equals(web3_js_1.PublicKey.default)),
                },
            };
        });
    }
    ...
    static getLiquidityAmountOutFromAmountIn({ poolInfo, inputA, tickLower, tickUpper, amount, slippage, add, token2022Infos, epochInfo, amountHasFee, }) {
        ...
        const _amount = addFeeAmount.amount.sub((_b = addFeeAmount.fee) !== null && _b !== void 0 ? _b : entity_1.ZERO).muln(coefficient);
        let liquidity;
    ...
    static getAmountsFromLiquidity({ poolInfo, tickLower, tickUpper, liquidity, slippage, add, token2022Infos, epochInfo, }) {
        ...
        const [amountA, amountB] = [
            (0, base_1.getTransferAmountFee)(amounts.amountA, (_a = token2022Infos[poolInfo.mintA.mint.toString()]) === null || _a === void 0 ? void 0 : _a.feeConfig, epochInfo, true),
            (0, base_1.getTransferAmountFee)(amounts.amountB, (_b = token2022Infos[poolInfo.mintB.mint.toString()]) === null || _b === void 0 ? void 0 : _b.feeConfig, epochInfo, true),
        ];
        const [amountSlippageA, amountSlippageB] = [
            (0, base_1.getTransferAmountFee)(amounts.amountA.muln(coefficientRe), (_c = token2022Infos[poolInfo.mintA.mint.toString()]) === null || _c === void 0 ? void 0 : _c.feeConfig, epochInfo, true),
            (0, base_1.getTransferAmountFee)(amounts.amountB.muln(coefficientRe), (_d = token2022Infos[poolInfo.mintB.mint.toString()]) === null || _d === void 0 ? void 0 : _d.feeConfig, epochInfo, true),
        ];
        return {
            liquidity,
            amountA,
    ...
    static computeAmountOutFormat({ poolInfo, tickArrayCache, token2022Infos, epochInfo, amountIn, currencyOut, slippage, }) {
        ...
        const { realAmountIn: _realAmountIn, amountOut: _amountOut, minAmountOut: _minAmountOut, expirationTime, currentPrice, executionPrice, priceImpact, fee, remainingAccounts, } = Clmm.computeAmountOut({
            poolInfo,
            tickArrayCache,
            baseMint: inputMint,
            amountIn: _amountIn,
    ...
    static computeAmountOutAndCheckToken({ connection, poolInfo, tickArrayCache, baseMint, amountIn, slippage, priceLimit = new decimal_js_1.default(0), }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static computeAmountOut({ poolInfo, tickArrayCache, baseMint, token2022Infos, epochInfo, amountIn, slippage, priceLimit = new decimal_js_1.default(0), }) {
        var _a, _b, _c, _d;
        let sqrtPriceLimitX64;
        ...
        const realAmountIn = (0, base_1.getTransferAmountFee)(amountIn, (_a = token2022Infos[baseMint.toString()]) === null || _a === void 0 ? void 0 : _a.feeConfig, epochInfo, false);
        const { expectedAmountOut: _expectedAmountOut, remainingAccounts, executionPrice: _executionPriceX64, feeAmount, } = pool_1.PoolUtils.getOutputAmountAndRemainAccounts(poolInfo, tickArrayCache, baseMint, realAmountIn.amount.sub((_b = realAmountIn.fee) !== null && _b !== void 0 ? _b : entity_1.ZERO), sqrtPriceLimitX64);
        const outMint = poolInfo.mintA.mint.equals(baseMint) ? poolInfo.mintB.mint : poolInfo.mintA.mint;
        const amountOut = (0, base_1.getTransferAmountFee)(_expectedAmountOut, (_c = token2022Infos[outMint.toString()]) === null || _c === void 0 ? void 0 : _c.feeConfig, epochInfo, false);
        ...
        const minAmountOut = (0, base_1.getTransferAmountFee)(_minAmountOut, (_d = token2022Infos[outMint.toString()]) === null || _d === void 0 ? void 0 : _d.feeConfig, epochInfo, false);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of fetchedBitmapAccount) {
                if (item.accountInfo === null)
                    continue;
                returnTypeFetchExBitmaps[item.pubkey.toString()] = layout_1.TickArrayBitmapExtension.decode(item.accountInfo.data);
            }
