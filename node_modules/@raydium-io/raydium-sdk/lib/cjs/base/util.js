...
const lookupTableCache_1 = require("./lookupTableCache");
...
function buildSimpleTransaction({ connection, makeTxVersion, payer, innerTransactions, recentBlockhash, }) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const itemIx of innerTransactions) {
            txList.push(_makeTransaction({
                ...
                lookupTableInfos: Object.values(Object.assign(Object.assign({}, lookupTableCache_1.LOOKUP_TABLE_CACHE), ((_a = itemIx.lookupTableAddress) !== null && _a !== void 0 ? _a : {}))),
            }));
        }
        return txList;
    });
