...
import type { AccountMeta, Instruction, WrappedInstruction } from './Instruction';
...
export declare class TransactionBuilder implements HasWrappedInstructions {
    ...
    addRemainingAccounts(accountMeta: AccountMeta | AccountMeta[], instructionIndex?: number): TransactionBuilder;
